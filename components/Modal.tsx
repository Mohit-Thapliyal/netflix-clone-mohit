        ...
        <div className="relative pt-[56.25%]">
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
              <button className="flex items-center gap-x-2  bg-white rounded px-8 text-xl font-bold text-black transition hover:bg-[#e6e6e6]">
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
          <div className="space-y-6 text-lg">
            ...
            <div className="flex flex-col gap-x-10 gap-y-4 font-light md:flex-row">
              <p className="w-5/6">{movie?.overview?.length!>300 ? movie?.overview.slice(0, 300) + " ...": movie?.overview}</p>
              <div className="flex flex-col space-y-3 text-sm">
                ...
                <div>
                  <span className="text-[gray]">Original name: </span>
